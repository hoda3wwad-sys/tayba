export default async function handler(req, res) {
  ...
  try {
    const payload = {
      ...
      // ===== أداة البحث الحقيقي (Grounding) =====
      // بدل ما النموذج يعتمد على ذاكرته الداخلية بس، بيقدر يرجع لنتائج بحث
      // حقيقية على الإنترنت ويبني إجابته عليها، فتقل فرصة الاختلاق أو التخمين.
      tools: [
        { google_search: {} }
      ],
      systemInstruction: {
        parts: [
          {
            text: `أنت مساعد اسمه "طيبة"، متخصص حصراً في السيرة النبوية الشريفة.
